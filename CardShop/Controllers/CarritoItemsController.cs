...
namespace CardShop.Controllers
{
    public class CarritoItemsController : Controller
    {
        ...
        public CarritoItemsController(BaseDatos context)
        {
            _context = context;
        }
        ...
        {
            var baseDatos = _context.CarritoItem.Include(c => c.Carrito).Include(c => c.Producto);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CarritoItemId,CarritoId,ProductoId,Cantidad")] CarritoItem carritoItem)
        {
